...
import com.chess.checkmate.bluetooth.BluetoothGameController;
import com.chess.checkmate.bluetooth.DeviceListActivity;
import com.chess.checkmate.gamelogic.CheckMateController;
import com.chess.checkmate.gamelogic.ChessParseError;
import com.chess.checkmate.gamelogic.Move;
import com.chess.checkmate.gamelogic.PgnToken;
import com.chess.checkmate.gamelogic.Position;
import com.chess.checkmate.gamelogic.TextIO;
import com.chess.checkmate.gamelogic.GameTree.Node;
...
@SuppressLint("NewApi")
public class CheckMate extends Activity implements GUIInterface {
	
	private ChessBoard cb;
	private CheckMateController ctrl = null;
	...
	private final String bookDir = "CheckMate";
	private final String pgnDir = "CheckMate" + File.separator + "pgn";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ctrl = new CheckMateController(this, gameTextListener, pgnOptions);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.item_editboard: {
			Intent i = new Intent(CheckMate.this, EditBoard.class);
		...
		case R.id.item_settings: {
			Intent i = new Intent(CheckMate.this, Preferences.class);
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int item) {
							...
							String pathName = Environment
									...
									+ sep
									+ pgnDir + sep + pgnFile;
							Intent i = new Intent(CheckMate.this,
									LoadPGN.class);
	...
	private final void setNotification(boolean show) {
		...
		if (show) {
			...
			CharSequence contentText = "Dark Knight is using a lot of CPU power";
