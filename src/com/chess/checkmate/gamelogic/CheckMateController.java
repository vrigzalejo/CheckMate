...
import com.chess.checkmate.GUIInterface;
import com.chess.checkmate.GameMode;
import com.chess.checkmate.PGNOptions;
import com.chess.checkmate.engine.ComputerPlayer;
import com.chess.checkmate.gamelogic.Game.GameState;
...
public class CheckMateController {
	...
	class SearchListener implements com.chess.checkmate.gamelogic.SearchListener {
	...
	public CheckMateController(GUIInterface gui,
