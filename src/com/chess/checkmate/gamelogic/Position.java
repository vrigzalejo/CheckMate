 ...
 * All required state is stored, except for all previous position
...
public class Position {
	...
	// But definitions for the castleMask bit mask.
	public static final int A1_CASTLE = 0; // White long castle
	public static final int H1_CASTLE = 1; // White short castle
	public static final int A8_CASTLE = 2; // White long castle
	public static final int H8_CASTLE = 3; // White short castle
